...
public class FancyConfirmScreen extends ConfirmScreen implements IgnoreCloseScreenPacket {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		if (parent != null)
			MVDrawableHelper.render(parent, matrices, -314, -314, delta);
		...
		Version.newSwitch()
				...
				.range(null, "1.19.4", () -> MVDrawableHelper.super_render(FancyConfirmScreen.class, this, matrices, mouseX, mouseY, delta))
				.run();
