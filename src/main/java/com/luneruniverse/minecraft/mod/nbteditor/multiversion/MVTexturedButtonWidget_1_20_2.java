...
class MVTexturedButtonWidget_1_20_2 extends ButtonWidget {
	...
	protected void renderButton(DrawContext context, int mouseX, int mouseY, float delta) {
		drawTexture(context, this.texture, getX(), getY(), this.u, this.v, this.hoveredVOffset,
				MVMisc.getWidgetWidth(this), MVMisc.getWidgetHeight(this), this.textureWidth, this.textureHeight);
	}
