...
public class NetworkingMixinPlugin extends BasicMixinPlugin {
	...
	public void addMixins(List<String> output) {
		Version.newSwitch()
				...
				.range("1.20.2", "1.20.4", () -> {
					output.add("toggled.ServerPlayNetworkHandlerMixin_1_20_2");
					output.add("toggled.ClientConnectionMixin_1_20_4");
				})
				.range(null, "1.20.1", () -> {
					output.add("toggled.ServerPlayNetworkHandlerMixin_1_20_1");
					output.add("toggled.ClientConnectionMixin_1_20_4");
				})
				.run();
	}
