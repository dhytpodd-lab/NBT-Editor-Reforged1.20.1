...
public class ServerMixinLink {
	...
	public static boolean isInstanceOfClientPlayNetworkHandlerSafely(PacketListener listener) {
		if (listener == null)
			return false;
		if (ClientPlayNetworkHandler != null && ClientPlayNetworkHandler.isInstance(listener))
			return true;
		
		String className = listener.getClass().getName();
		return className.equals("net.minecraft.client.multiplayer.ClientPacketListener") ||
				className.endsWith(".ClientPlayNetworkHandler");
	}
