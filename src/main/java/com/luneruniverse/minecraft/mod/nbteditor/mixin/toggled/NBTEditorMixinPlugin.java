...
public class NBTEditorMixinPlugin extends BasicMixinPlugin {
	...
	public void addMixins(List<String> output) {
		...
		Version.newSwitch()
				.range("1.20.2", null, () -> output.add("toggled.DrawContextMixin"))
		...
		Version.newSwitch()
				...
				.range("1.21.1", "1.21.1", () -> output.add("toggled.GameRendererMixin_1_21_1"))
				.range(null, "1.21.0", () -> {})
				.run();
		Version.newSwitch()
				.range("1.21.4", null, () -> {
				...
				.range("1.21.0", "1.21.3", () -> output.add("toggled.BuiltinModelItemRendererMixin"))
				.range(null, "1.20.6", () -> {})
				.run();
		Version.newSwitch()
