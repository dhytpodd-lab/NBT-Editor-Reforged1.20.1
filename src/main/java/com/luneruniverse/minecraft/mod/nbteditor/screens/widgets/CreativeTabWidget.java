...
public class CreativeTabWidget implements MVDrawable, MVElement {
	...
	public static void addCreativeTabs(Screen screen) {
		...
		if (!tabs.isEmpty()) {
			...
			addDrawableChild(screen, group);
		}
	}
	@SuppressWarnings({"rawtypes", "unchecked"})
	private static void addDrawableChild(Screen screen, GroupWidget group) {
		screen.drawables.add(group);
		((List) screen.children()).add(group);
	}
